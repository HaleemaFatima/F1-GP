...
export const EventDetail: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loadEventData();
  }, [eventId, navigate, setCurrentEvent, setSeatMap, setLoading, addToast]);
  ...
  }, [eventId, selectedSeats, currentHold, userId, setSelectedSeats, setCurrentHold, addToast, setSeatMap]);
